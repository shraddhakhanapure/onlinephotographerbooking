      ...
      <form class="row text-center">
        <div class="col-md-auto">
          <div class="form-group mb-2">
            <input type="text" class="form-control" placeholder="Enter Keywords to search"  id="search">
          </div>
...
try {
 ...
 <% 
	...
	<% }
		...
		%>
		      <!-- start slider -->
      <div class="team slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1}' class="content" id="content">		
		<%		
		do
		{
			%>
	        ...
	        <div class="card border-0 text-center ml-3 mr-3">
	          ...
	          <div class="card-body">
	            ...
	            <div class="person-description mt-2">
	              ...
	              <div class="person-description mt-2">
	           <input type="button" class="btn btn-info" value="Know More" onclick=" relocate_home4()" align="right">
...
<!------------------------------------------------------ Start Drone specialist  ------------------------------------------------------------------>
 ...
 <% 
	...
	<% }
		...
		%>
		      <!-- start slider -->
      <div class="team slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1}' id="content" class="content">		
		<%		
		do
		{
			%>
